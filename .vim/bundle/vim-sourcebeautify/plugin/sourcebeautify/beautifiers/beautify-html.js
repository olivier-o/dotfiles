...
---------------
  ...
  The options are:
    indent_size (default 2)          — indentation size,
...
function js_beautify(js_source_text, options) {
    ...
    function get_next_token() {
        ...
        if (keep_whitespace) {
            ...
            // var a = [
            // ....'something'
            // we make note of whitespace_count = 2 into flags.indentation_baseline
            // so we know that 2 whitespaces in original source match indent_level of reindented source
            //
